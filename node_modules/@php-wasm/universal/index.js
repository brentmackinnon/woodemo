...
const _FSHelpers = class m {
  ...
  static mv(e, r, s) {
    try {
      ...
      i.mountpoint !== n.mountpoint ? (m.copyRecursive(e, r, s), m.isDir(e, r) ? m.rmdir(e, r, { recursive: !0 }) : e.unlink(r)) : e.rename(r, s);
    } catch (i) {
...
async function loadPHPRuntime(t, e = {}) {
  ...
  return n.FS, n.id = o, n.originalExit = n._exit, n._exit = function(a) {
